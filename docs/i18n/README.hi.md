...
| 🔗 | एजेंट MCP ब्रिज | Claude Code से Gemini, Codex, Aider और 20+ अन्य एजेंटों को कार्य सौंपें |
...
- **एजेंट MCP में नहीं दिख रहा**: सुनिश्चित करें कि एजेंट बाइनरी `PATH` पर है (`which gemini`)। केवल इंस्टॉल एजेंट `tools/list` में दिखाई देते हैं।

...
`claudy mcp run` चलाएं ताकि एक stdio-आधारित MCP server शुरू हो जो Claude Code को अन्य लोकल AI coding agents को टास्क सौंपने देता है।

```bash
claudy mcp run        # MCP server शुरू करें (Claude Code द्वारा कॉल किया जाता है)
claudy mcp install    # claudy को Claude Code settings में MCP server के रूप में पंजीकृत करें
claudy mcp uninstall  # Claude Code MCP settings से claudy हटाएं
```

`claudy mcp install` स्वचालित रूप से `~/.claude/settings.json` में खुद को रजिस्टर करता है। जब आप `claudy mode create <name>` के साथ कोई Mode बनाते हैं, तो यह mode की settings फ़ाइल में भी रजिस्टर हो जाता है। कोई मैन्युअल कॉन्फ़िगरेशन आवश्यक नहीं।
...
claudy analytics sync-pricing      # models.dev और Anthropic pricing पेज से model pricing सिंक करें
claudy analytics recalculate       # नवीनतम pricing डेटा का उपयोग करके सभी लागतों की पुनर्गणना करें
claudy analytics insights          # LLM विश्लेषण के लिए compact JSON सारांश बनाएं (डिफ़ॉल्ट: 7 दिन)
claudy analytics insights --days 14  # पिछले 14 दिनों का विश्लेषण करें
claudy analytics insights --from 2026-04-01 --to 2026-04-30  # विशिष्ट तिथि सीमा
claudy analytics insights --project my-project  # प्रोजेक्ट द्वारा फ़िल्टर करें
```
...
Claude `claudy analytics insights` चलाता है, JSON का विश्लेषण करता है, और एक संरचित रिपोर्ट लौटाता है जिसमें शामिल हैं:

- **लागत रुझान** — spike detection के साथ दैनिक/साप्ताहिक खर्च
- **मॉडल वितरण** — आप कौन से मॉडल उपयोग करते हैं और प्रति सत्र उनकी लागत क्या है
- **टूल पैटर्न** — सबसे अधिक उपयोग किए जाने वाले टूल, error rates, efficiency observations
- **कैश प्रदर्शन** — hit ratio और अनुमानित बचत
- **कार्रवाई योग्य अनुशंसाएँ** — विशिष्ट सुझाव जैसे "route simple tasks to turbo" अनुमानित डॉलर बचत के साथ

उदाहरण आउटपुट (raw data के लिए [`docs/examples/analytics-insights-sample.json`](docs/examples/analytics-insights-sample.json) देखें):
...
कोई मैन्युअल कमांड नहीं, कोई context switching नहीं। Claude से अपने उपयोग के बारे में पूछें और तुरंत उत्तर पाएं।

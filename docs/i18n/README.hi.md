...
- **इनसाइट्स (LLM-संचालित)**: LLM विश्लेषण के लिए अनुकूलित compact JSON प्रारूप में उपयोग सारांश। लागत रुझान, मॉडल वितरण, टूल पैटर्न, कैश दक्षता और उल्लेखनीय सत्रों को एकल पेलोड (~2-3K tokens) में संयोजित करता है। Claude Code की `analytics-insights` स्किल के माध्यम से प्राकृतिक भाषा में उपयोग करें — Claude व्यक्तिगत अनुशंसाएँ उत्पन्न करता है।

# install.ps1 — one-line installer for claudy (Windows)
# Usage: irm https://github.com/epicsagas/claudy/releases/latest/download/install.ps1 | iex
param(
...
$tmpdir  = New-Item -ItemType Directory -Path (Join-Path $env:TEMP "claudy-install-$pid") -Force
